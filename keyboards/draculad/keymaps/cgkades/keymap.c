...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] =  LAYOUT(
        ...
        LSFT_T(KC_Z), KC_X,    KC_C,    KC_V,    KC_B,                                                 KC_N,             KC_M,    KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),
                                                 KC_MUTE,                                              TG(_ADJ),
                                        KC_LCTL, KC_LGUI, LT(_NUM,KC_BSPC),    LT(_SYMB,KC_SPC), LT(_MUS ,KC_ENT), KC_LALT
    ),
    [_NUM] = LAYOUT(
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_TAB,  XXXXXXX, KC_VOLD, KC_VOLU, XXXXXXX,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT,
        KC_LSFT, XXXXXXX, XXXXXXX, KC_MUTE, XXXXXXX,                        KC_HOME, KC_END,  KC_PGUP, KC_PGDN, KC_ENT,
                                            XXXXXXX,                      KC_NO,
                                   XXXXXXX, KC_LALT, _______,    KC_ENT, XXXXXXX,  KC_NO
    ),
    [_SYMB] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,                        XXXXXXX, XXXXXXX, XXXXXXX, KC_EQL,  KC_MINS,
        KC_ESC, KC_F5,   KC_F6,   KC_F7,   KC_F8,                        KC_LBRC, KC_RBRC, XXXXXXX, KC_GRV,  KC_BSLS,
        KC_LSFT, KC_F9,   KC_F10,  KC_F11,  KC_F12,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
                                            XXXXXXX,                      KC_NO,
                                   KC_LALT, XXXXXXX, KC_DEL,    _______, XXXXXXX, KC_NO
    ),
    [_MUS] = LAYOUT(
