...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] =  LAYOUT(
        ...
        LSFT_T(KC_Z), KC_X,    KC_C,    KC_V,    KC_B,                                             KC_N,    KC_M,    KC_COMM, KC_DOT,  RSFT_T(KC_ENT),
                                                 KC_MUTE,                                          TG(_ADJ),
                                        KC_LCTL, KC_LGUI, LT(_NUM,KC_BSPC),    LT(_SYMB,KC_SPACE), LT(_MUS,KC_ENT), KC_LALT
    ),
    [_NUM] = LAYOUT(
        ...
        KC_LSFT, XXXXXXX, XXXXXXX, KC_MUTE, QK_BOOT,                      KC_HOME, KC_END,  KC_PGUP, KC_PGDN, KC_RSFT,
                                            XXXXXXX,                      KC_NO,
                                   XXXXXXX, KC_LALT, _______,    _______, KC_ENT,  KC_NO
    ),
    [_SYMB] = LAYOUT(
        ...
        KC_LSFT, KC_F9,   KC_F10,  KC_F11,  KC_F12,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
                                            XXXXXXX,                      KC_NO,
                                   KC_LALT, XXXXXXX, _______,    _______, XXXXXXX, KC_NO
    ),
    [_MUS] = LAYOUT(
