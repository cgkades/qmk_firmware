...
LAYOUT(
  ...
  KC_APP, KC_LCTL, KC_LALT, KC_LGUI,  MO(1),      KC_SPC,        MO(2),  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
LAYOUT( /* Left  */
  ...
  _______, RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, RGB_HUI, RGB_HUD, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
...
LAYOUT( /* Right */
  ...
  /* FN Layer 3
   * ,-------------------------------------------------------------------------.
   * |     | Calc|Webhm| Mail| Comp|     |     |     |     |     |PrtSc|  Rst  |
   * |-------------------------------------------------------------------------+
   * |      |     |     |     |     |     |     |     |     |     |     |      |
   * |-------------------------------------------------------------------------+
   * |       |    |     |     |     |     |     |     |     |     |     |     |
...
LAYOUT( /* Tab */
  _______,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, _______, _______, KC_PSCR, RESET,
